      ...
      >
        ...
        <div className="hidden lg:block relative h-20">
          ...
          <motion.a
            href="#home"
            onClick={(e) => { e.preventDefault(); scrollTo("home"); }}
            className="absolute left-8 top-1/2 -translate-y-1/2 flex items-center gap-2.5"
            style={{ pointerEvents: "auto" }}
          ...
          {/* Links pill — CENTER (pill stays) */}
          <div
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-1 rounded-full border px-2 py-2"
            style={{ ...centerPillStyle, pointerEvents: "auto" }}
          >
          ...
          >
            ...
            <motion.a
              ...
              className="flex items-center gap-1.5 rounded-full px-4 py-2 text-[13px] font-semibold text-white ml-1"
        ...
        {mobileOpen && (
          ...
          >
            ...
            >
              <motion.button
                onClick={() => setLocale(locale === "en" ? "es" : "en")}
                className="flex items-center justify-center h-10 px-4 rounded-full border text-sm font-semibold tracking-wider"
                style={{
                  color: "var(--dim)",
                  borderColor: "var(--border-s)",
